...
require_once(u_src()."entidad/fin_documento.php");
class dao_fin_documento { 
   private $conecta;
   ...
   public function consulta($sql){
	...
	public function insertar(fin_documento $obj){
         $sql="";
          return $this->conecta->sql_query($sql);
	}
	public function modificar(fin_documento $obj){
         $sql="";
          return $this->conecta->sql_query($sql);
	}
