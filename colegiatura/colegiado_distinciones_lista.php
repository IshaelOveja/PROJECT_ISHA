...
$data_distinciones  = $bo_distinciones->listar($cc_persona);
...
<div class="row">
    <div class="col-12">
                ...
                <h1 class="m-b-xs"><a href="javascript:fn_controlDistinciones('','<?php echo $cc_persona?>','I');" class="btn btn-info" role="button"> <i class="fa fa-plus"></i> Nuevo</a></h1>
           	 
             <div id="imprimir">
                 <div id="TablaExportar">
                 <div class="text-center"><h3><strong>DATOS DE DISTINCIONES</strong></h3></div>
                 ...
                 <table class="table table-striped table-hover">
                    ...
                    <tbody >
                    <?php $i=1;
						foreach($data_distinciones as $row){?>
                    <tr>
                            <td ><?php echo $i ?></td>
                            <td><?php echo $row["fecha"] ?></td>
                            <td><?php echo $row["distincion"];?></td>
                            <td><?php echo $row["denominacion"];?></td>
                            <td><?php echo u_vigencia($row["estado"]);?></td>
                            <td ><a href="javascript:fn_controlDistinciones('<?php echo $row["cc_distinciones"]?>','<?php echo $row["cc_persona"]?>','U');" data-original-title="Editar"> <i class="fa fa-pencil text-inverse m-r-10"></i></a>
                                <a href="javascript:fn_eliminarDistinciones('<?php echo $row["cc_distinciones"]?>','<?php echo $row["cc_persona"]?>');" data-original-title="Eliminar"> <i class="fa fa-close text-danger"></i> </a></td>
                        </tr>
                    <?php $i++;}?>
                    	</tbody>
					</table>
